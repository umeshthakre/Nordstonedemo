    ...
    {touched.email && errors.email &&
     ...
     />
      {touched.cpass && errors.cpass &&
              <Text style={{ fontSize: 12, color: '#FF0D10',marginBottom:5, alignSelf:"center" }}>{errors.cpass}</Text>
            }
    <Text style = {styles.loginhere}>
    Alraedy have a account <Text onPress={()=>{navigation.navigate("login")}} style = {{color:"blue"}}>
