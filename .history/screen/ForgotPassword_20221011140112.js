...
const ForgotPassword = () => {
  ...
  return (
    ...
    {({values,errors,handleChange,setFieldTouched,touched,handleSubmit,isValid})=>(
        <>
        <TextInput
    style={styles.input1}
        label = "Email"
    ...
    <Text style = {{color:"black", marginTop:10,alignSelf:"center"}}>Check the spam folders for the password reset mail</Text>
    <Snackbar
    style={{marginTop:"80%"}}
        visible={visible}
